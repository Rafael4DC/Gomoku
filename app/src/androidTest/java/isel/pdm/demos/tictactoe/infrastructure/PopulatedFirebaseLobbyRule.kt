...
import isel.pdm.gomoku.infrastructure.CHALLENGER_FIELD
import isel.pdm.gomoku.infrastructure.LOBBY
import isel.pdm.gomoku.infrastructure.LobbyFirebase
//import isel.pdm.gomoku.infrastructure.toChallengeOrNull
import isel.pdm.gomoku.infrastructure.toDocumentContent
...
class PopulatedFirebaseLobbyRule : TestRule {
    ...
    suspend fun getChallengeInfo(challengedPlayer: PlayerInfo): Any = Any()
        /*testApp.emulatedFirestoreDb
            .collection(LOBBY)
