 ...
 */
class LobbyFirebase(private val db: Any) : Lobby {
    ...
    private fun subscribeRoasterUpdated(flow: ProducerScope<LobbyEvent>):Any = TODO()
...
private sealed interface LobbyState {
    ...
    data class InsideLobby(
        ...
        val localPlayerDocRef: Any,//DocumentReference,
...
fun UserInfo.toDocumentContent() = mapOf(
    isel.pdm.gomoku.infrastructure.NICK_FIELD to nick,
    isel.pdm.gomoku.infrastructure.MOTTO_FIELD to motto
)
