...
import isel.pdm.gomoku.TAG
import isel.pdm.gomoku.domain.game.lobby.Challenge
import isel.pdm.gomoku.domain.game.lobby.Lobby
import isel.pdm.gomoku.domain.game.lobby.LobbyEvent
import isel.pdm.gomoku.domain.game.lobby.PlayerInfo
import isel.pdm.gomoku.domain.user.UserInfo
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.EnteringLobby
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.IncomingChallenge
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.InsideLobby
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.LobbyAccessError
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.OutsideLobby
import isel.pdm.gomoku.ui.game.lobby.LobbyScreenState.SentChallenge
...
sealed interface LobbyScreenState {
     ...
     * @property other
     * Players the information of the other players in the lobby.
     */
    data class InsideLobby(val localPlayer: PlayerInfo, val otherPlayers: List<PlayerInfo>) :
        LobbyScreenState
     ...
     */
    data class IncomingChallenge(val localPlayer: PlayerInfo, val challenge: Challenge) :
        LobbyScreenState
     ...
     * @property challenge the challenge information.
     */
    data class SentChallenge(val localPlayer: PlayerInfo, val challenge: Challenge) :
        LobbyScreenState
}
