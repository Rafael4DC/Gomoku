package isel.pdm.gomoku.ui.game.play
...
interface GamePlayScreenState {
     ...
     */
    data class Starting(val localPlayerMarker: Marker, val challenge: Challenge) :
        GamePlayScreenState
     ...
     */
    data class Finished(val localPlayerMarker: Marker, val game: Game.Finished) :
        GamePlayScreenState
